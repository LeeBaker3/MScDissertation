...
@SessionScoped
public class DistributionrecipientController implements Serializable {

    private Distributionrecipient current;
    private DataModel items = null;
    @EJB
    private Entities.DistributionrecipientFacade ejbFacade;
    ...
    public static class DistributionrecipientControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Distributionrecipient) {
                ...
                return getStringKey(o.getDistributionRecipientID());
            } else {
