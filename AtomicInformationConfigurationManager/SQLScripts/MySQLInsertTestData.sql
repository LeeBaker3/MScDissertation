...
-- -----------------------------------------------------
 ...
 INSERT INTO atomicinformation (`ArtefactID`, `TypeOfAtomicInformationID`, `VersionNumber`, `IsCurrentVersion`, `PreviousVersionReference`, `EntityActive`, `Content`, `ProjectID`) 
	VALUES (1, 1, 1, true, NULL, true, 'Requirement 1: Must Be able to Save Something', 1) ON DUPLICATE KEY UPDATE
 ...
 INSERT INTO atomicinformation (`ArtefactID`, `TypeOfAtomicInformationID`, `VersionNumber`, `IsCurrentVersion`, `PreviousVersionReference`, `EntityActive`, `Content`, `ProjectID`) 
	VALUES (1, 3, 1, true, NULL, true, 'Senior User: Joe Bloggs', 1) ON DUPLICATE KEY UPDATE
	ArtefactID=VALUES(ArtefactID),
	TypeOfAtomicInformationID=VALUES(TypeOfAtomicInformationID),
	VersionNumber=VALUES(VersionNumber), 
	IsCurrentVersion=VALUES(IsCurrentVersion), 
 ...
 INSERT INTO atomicinformation (`ArtefactID`, `TypeOfAtomicInformationID`, `VersionNumber`, `IsCurrentVersion`, `PreviousVersionReference`, `EntityActive`, `Content`, `ProjectID`) 
	VALUES (2, 2, 1, true, NULL, true, 'Function001: When User Presses Save Check No Current Matching Records', 1) ON DUPLICATE KEY UPDATE
	ArtefactID=VALUES(ArtefactID),
	TypeOfAtomicInformationID=VALUES(TypeOfAtomicInformationID),
	VersionNumber=VALUES(VersionNumber), 
	IsCurrentVersion=VALUES(IsCurrentVersion), 
 ...
 INSERT INTO atomicinformation (`ArtefactID`, `TypeOfAtomicInformationID`, `VersionNumber`, `IsCurrentVersion`, `PreviousVersionReference`, `EntityActive`, `Content`, `ProjectID`) 
	VALUES (3, 4, 1, true, NULL, true, 'John Doe', 1) ON DUPLICATE KEY UPDATE
	ArtefactID=VALUES(ArtefactID),
	TypeOfAtomicInformationID=VALUES(TypeOfAtomicInformationID),
	VersionNumber=VALUES(VersionNumber), 
	IsCurrentVersion=VALUES(IsCurrentVersion), 
